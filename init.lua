...
cmodal:bind('', 'escape', '关闭', function() spoon.ModalMgr:deactivate({"appM"}) end)
cmodal:bind('', 'Q', '关闭', function() spoon.ModalMgr:deactivate({"appM"}) end)
...
for _, v in ipairs(hsapp_list) do
    ...
    elseif v.name then
        cmodal:bind('', v.key, v.desc, function()
...
if spoon.WinWin then
    ...
    hsresizeM_keys = hsresizeM_keys or {"alt", "D"}
